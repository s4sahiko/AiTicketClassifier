...
RAW_DATA_FILE = os.path.join(REGISTRY_DIR, 'cleaned_ticket_data.csv')
CLEANED_DATA_FILE = os.path.join(REGISTRY_DIR, 'knowledge_base_with_embeddings.csv')
EMBEDDINGS_FILE = os.path.join(REGISTRY_DIR, 'kb_embeddings.npy')
